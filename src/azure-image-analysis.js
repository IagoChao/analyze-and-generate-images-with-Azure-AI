...
const analyzeImage = async (url) => {
    ...
    const endpoint = "https://computer-vision-iago-ai.cognitiveservices.azure.com//computervision/imageanalysis:analyze?api-version=2023-04-01-preview&features=tags,objects,caption,denseCaptions,read,smartCrops,people";
